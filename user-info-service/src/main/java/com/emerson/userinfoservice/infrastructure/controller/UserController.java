package com.emerson.userinfoservice.infrastructure.controller;
...
import com.emerson.userinfoservice.infrastructure.service.user.CreateUserServiceFacade;
import com.emerson.userinfoservice.infrastructure.service.user.DeleteUserServiceFacade;
import com.emerson.userinfoservice.infrastructure.service.user.FindUserServiceFacade;
import com.emerson.userinfoservice.infrastructure.service.user.UpdateUserServiceFacade;
...
public class UserController {
	...
	public ResponseEntity<User> updatePersonalInfo(@PathVariable String id, @RequestBody @Valid UpdatePersonalInfoRequest personalInfoRequest) {
